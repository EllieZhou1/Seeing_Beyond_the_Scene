...
#SBATCH -o slurm/outfile_38B_mix1        # send stdout to outfile
#SBATCH -e slurm/errfile_38B_mix1  # send stderr to errfile
...
python llm_experiments/78B_full_hat_actionswap.py --model_name InternVL3-38B --mix 1