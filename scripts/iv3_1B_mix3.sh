...
#SBATCH -o slurm/outfile_1B_mix3        # send stdout to outfile
#SBATCH -e slurm/errfile_1B_mix3  # send stderr to errfile
...
python llm_experiments/78B_full_hat_actionswap.py --model_name InternVL3-1B --mix 3