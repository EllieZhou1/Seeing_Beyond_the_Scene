...
#SBATCH -o slurm/outfile_clip_mix2       # send stdout to outfile
#SBATCH -e slurm/errfile_clip_mix2  # send stderr to errfile
...
python clip_experiments/action_swap_400_mcq.py --mix 2