...
#SBATCH -o slurm/outfile_siglip_mix3       # send stdout to outfile
#SBATCH -e slurm/errfile_siglip_mix3  # send stderr to errfile
...
python siglip/action_swap_400_mcq.py --mix 3