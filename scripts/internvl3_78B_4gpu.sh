...
#SBATCH -o slurm/outfile_78B_mix1        # send stdout to outfile
#SBATCH -e slurm/errfile_78B_mix1  # send stderr to errfile
...
python llm_experiments/temp.py --model_name InternVL3-78B --mix 1
# python llm_experiments/78B_full_hat_actionswap.py --model_name InternVL3-78B --mix 2