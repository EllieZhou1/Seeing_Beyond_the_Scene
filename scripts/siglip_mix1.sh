...
#SBATCH -o slurm/outfile_siglip_mix1       # send stdout to outfile
#SBATCH -e slurm/errfile_siglip_mix1  # send stderr to errfile
...
python siglip/action_swap_400_mcq.py --mix 1