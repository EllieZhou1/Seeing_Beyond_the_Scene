...
#SBATCH -o slurm/outfile_siglip      # send stdout to outfile
#SBATCH -e slurm/errfile_siglip  # send stderr to errfile
...
python siglip/action_swap_400.py --mix 1
python siglip/action_swap_400.py --mix 2
python siglip/action_swap_400.py --mix 3