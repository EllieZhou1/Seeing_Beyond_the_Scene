...
output_root = "dataset/segmented_action_swap"
og_csv_path = "dataset/action_swap_dataset.csv"
...
yolo = YOLO("yolov5s.pt")  # Let Ultralytics handle CUDA automatically
print("Here1")
