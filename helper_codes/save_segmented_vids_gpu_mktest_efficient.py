...
output_root_seg = "/n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/dataset/minikinetics50/new_segmented_minikinetics50_test"
output_root_binarymask = "/n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/dataset/minikinetics50/new_binarymasks_minikinetics50_test"

og_csv_path = "/n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/dataset/minikinetics50/minikinetics50_test_all.csv"

final_csv_path_all = "/n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/dataset/minikinetics50/new_minikinetics50_test_all.csv"
final_csv_path_only_hasHuman = "/n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/dataset/minikinetics50/new_minikinetics50_test_only_hasHuman.csv" #the csv where we will put ONLY the 
#samples where a human was found
final_csv_path_only_noHuman = "/n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/dataset/minikinetics50/new_minikinetics50_test_only_noHuman.csv"
...
wandb.init(
    ...
    name="save_segmented_vids_for_MK50_test_EFFICIENT",             # Optional: run name
    config={
