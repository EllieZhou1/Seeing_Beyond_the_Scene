...
minikinetics_csv_path = os.path.join(base_dir, "dataset/minikinetics50/minikinetics50_validation_all.csv")
places365_csv_path= os.path.join(base_dir, "dataset/places365.csv")

summary_csv_path = os.path.join(base_dir, "dataset/places365/places365_actionswap_summary_val.csv")
out_csv_path = os.path.join(base_dir, "dataset/places365/places365_actionswap_val.csv")
out_img_path = os.path.join(base_dir, "dataset/places365/places365_actionswap_val")
