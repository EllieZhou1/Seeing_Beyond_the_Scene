...
wandb.init(
    ...
    name="save_segmented_vids_for_Mimetics",             # Optional: run name
    config={
...
#   - hasPerson: a boolean
def run_yolo_and_seg(row, predictor, device):
...
def process_row(row, gpu_id=0):
    ...
    segmented_frames, binarymask_frames, hasPerson, all_bboxes_info, vis_img_path = run_yolo_and_seg(row, predictor, device)
