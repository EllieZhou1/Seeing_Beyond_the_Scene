...
json_name = "weighted_focus2_mix_mimetics final.json"

#slow_r50_mix_mimetics final.json
#slow_humanseg_mix_mimetics final.json
#sum_concat_mix_mimetics final.json
#stack_concat_mix_mimetics final.json
#weighted_focus2_mimetics final.json
