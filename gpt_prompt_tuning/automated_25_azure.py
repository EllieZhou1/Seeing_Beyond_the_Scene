...
os.makedirs("gpt/new_action_swap_results_train_25", exist_ok=True)

prompt_log_path = "gpt/new_action_swap_results_train_25/generated_prompts_log.txt"
...
# === SETUP CLIENT ===
client_async = AsyncAzureOpenAI( #For image-text prompts
    api_key="",
    api_version="2024-02-01",
    azure_endpoint="https://api-ai-sandbox.princeton.edu/"
)

client_sync = AzureOpenAI( #For text-only
    api_key="",
    api_version="2024-02-01",
    azure_endpoint="https://api-ai-sandbox.princeton.edu/"
)
