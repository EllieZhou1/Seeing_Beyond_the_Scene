...
def main():
    ...
    #Load the json file
    with open(f"/n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/gpt/4o-mini_automated_prompt_{prompt_num}_75_mini_actionswap/filtered_prompts.json", "r") as f:
